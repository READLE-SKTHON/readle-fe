...
export default function GameExitModal({ title, description, onClose, onExit }: GameExitModalProps) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-5">
      ...
      <div className="relative z-10 w-full max-w-sm rounded-3xl bg-white px-6 py-7">
        <h2 className="text-center text-[20px] font-bold">{title ?? "게임을 종료할까요?"}</h2>
