      ...
      {!isSubmitted && (
        <>
          ...
          <div className="flex items-center justify-between">
            <span className="rounded-full bg-[#D5EAFB] px-4 py-2 text-[16px] font-bold text-[#168CF2]">
              O/X문제
            </span>
            ...
            <button
              type="button"
              onClick={onOpenNews}
              className="cursor-pointer rounded-full bg-[#EFF238] px-4 py-2 text-[16px] font-bold"
            >
              지문 전체보기
            </button>
          </div>
